# tf-atom-iam-group-aws

[![CI](https://github.com/PlatformStackPulse/tf-atom-iam-group-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-iam-group-aws/actions/workflows/ci.yml)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-iam-group-aws)](https://github.com/PlatformStackPulse/tf-atom-iam-group-aws/releases)
...
Terraform atom: AWS IAM Group - creates a single IAM group
